...
// Interface untuk TypeScript agar tidak error saat akses properti
interface Project {
  id: string;
  title: string;
  description: string;
...
export default function Index() {
  // Ganti usePortfolio dengan state lokal untuk menampung data Firebase
  const [featured, setFeatured] = useState<Project[]>([]);

  useEffect(() => {
    const fetchFeatured = async () => {
      try {
        // Query: Ambil project yang 'featured' == true, batasi 3 item
        const q = query(
  ...
  return (
      <PublicLayout>
        ...
        {/* Featured Projects - (UI TETAP, SUMBER DATA DARI STATE FIREBASE) */}
                  ...
                  >
                    ...
                    <span className="font-mono text-xs text-primary uppercase tracking-wider">
                      ...
                      <div className="flex flex-wrap gap-2 mt-auto">
                        {/* Pastikan techStack ada sebelum di-slice */}
